...
<![endif]-->
    ...
    <![endif]-->
    <title>图片列表</title>
    <link href="${pageContext.request.contextPath}/res/lib/lightbox2/2.8.1/css/lightbox.css" rel="stylesheet" type="text/css">
</head>
<body>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/res/lib/lightbox2/2.8.1/js/lightbox.min.js"></script>
