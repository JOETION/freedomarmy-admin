	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		<thead>
			<tr class="text-c">
				...
				<th>导师简介</th>
				<th width="100">学生数量</th>
				<th width="90">已选学生数量</th>
				<th width="250">操作</th>
			</tr>
		</thead>
		<tbody>
		<c:forEach var="teacher" items="${teacherList}">
			<tr class="text-c">
				...
				<td class="td-manage"><input class="btn btn-primary radius" onclick="assign_student('为${teacher.name}老师分配学生','choise/studentsmajor?teacherId=${teacher.id}',720,540)" type="button" value="分配未选学生"><input class="btn btn-primary radius" onclick="assign_student('为${teacher.name}老师分配学生','choise/studentsallmajor?teacherId=${teacher.id}',720,540)" type="button" value="分配所有学生"></td>
			</tr>
		</c:forEach>
		</tbody>
	</table>
