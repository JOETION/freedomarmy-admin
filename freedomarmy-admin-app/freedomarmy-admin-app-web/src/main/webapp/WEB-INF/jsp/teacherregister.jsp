			...
			<div class="docs-tip">
				<form action="teacher_register" method="post" class="form form-horizontal responsive" id="regist-form">
					...
					<div class="row cl">
						...
						<div class="formControls col-5">
							<input type="text" class="input-text" autocomplete="off" placeholder="姓名" name="name" id="username" datatype="n" nullmsg="工号不能为空！">
						</div>
						<div class="col-4">
					...
					<div class="row cl">
						...
						<div class="formControls col-5">
							<input type="text" class="input-text" autocomplete="off" placeholder="职称" name="jobtitle" id="username" datatype="n" nullmsg="工号不能为空！">
						</div>
						<div class="col-4">
